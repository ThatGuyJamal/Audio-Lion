...
mod cpal {
    ...
    impl CpalAudioOutput {
        pub fn try_open(
            app_handle: tauri::AppHandle, spec: SignalSpec, duration: Duration
    ...
    impl<T: AudioOutputSample> CpalAudioOutputImpl<T> {
        pub fn try_open(
            ...
            // Create a ring buffer with a capacity for up-to 800ms of audio.
            let ring_len = ((800 * spec.rate as usize) / 1000) * num_channels;
...
pub fn try_open(
    ...
    spec: SignalSpec,
    duration: Duration,
    _app_name: &str, // Only used on Linux.
) -> Result<Box<dyn AudioOutput>> {
